...
os.system(f'python -m torch.distributed.run --nnodes 1 --nproc_per_node 4 generate.py --task animate-14B --ckpt_dir ./Wan2.2-Animate-14B/ --src_root_path /workspace/Wan2.2/wan/process_results --refert_num 1 --dit_fsdp --t5_fsdp --ulysses_size 4')
